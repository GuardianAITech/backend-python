...
def analyze_with_gpt4(transaction_json):
    ...
    f"Transaction: \n{transaction_json}\n\n"
    "Replace ######### with actual data you can find in the transaction. And take out sentences you dont need or add if you need something more to tell."
    "Please create your summary text like this:\n"
    "Block Signed At: The transaction was included in a block on#########.\n"
    "Block Height: The transaction was in block number #########.\n"
    ...
    "0\n"
    "#########, which means no ETH was transferred, suggesting it was a token transaction or a contract interaction.\n\n"
    
    "Gas Details:\n"
    "Gas Offered: The maximum amount of gas the sender was willing to use for the transaction was ######### units.\n"
    "Gas Spent: The actual gas used was ######### units.\n"
    "Gas Price: The price per unit of gas was ######### wei.\n"
    "Fees Paid: The total fee for the transaction was\n"
    "#########\n"
    "wei (equivalent to {{#########/1000000000000000000}} ETH), or approximately $######### USD at the given rate.\n\n"
    
    "Dex Details:\n"
    "A swap event took place on the #########.\n"
    "From Token:\n"
    "#########\n"
    ...
    "#########\n"
    "ide tokens to\n"
    "######### wei of WETH (equivalent to {{#########/1000000000000000000}} ETH).\n"
    "Value of Swap: The quoted USD value of the tokens swapped was roughly $#########, indicating a likely swap of ide tokens for an equivalent value of WETH.\n\n"
    ...
    "The log events include interactions with the WETH token and the ######### token as part of the swap on Uniswap V2.\n\n"
    
    "The transaction seems to represent a token swap on #########, a decentralized exchange, where the sender exchanged\n"
    "ide\ntokens for\n"
    "WETH\n"
